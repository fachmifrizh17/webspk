...
<page>
    ...
    <div id="judul" class="text-center">
        <p class="text-underline">Laporan Data Kriteria</p>
    </div>
    <div id="body">
        <?php
        ...
        $query = "select a.id_nilaikriteria, a.id_kriteria,b.namaKriteria,a.nilai,a.keterangan from nilai_kriteria a left join kriteria b on b.id_kriteria = a.id_kriteria";
