...
<page>
    ...
    <div id="judul" class="text-center">
        <p class="text-underline">Laporan Data Peserta</p>
    </div>
    <div id="body">
        <div class="table-container">
            ...
            $query = "SELECT nama_peserta, alamat_peserta, usia_peserta, hp_peserta, jenis_kelamin, email FROM peserta";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>{$row['usia_peserta']}</td>
                            <td>{$row['hp_peserta']}</td>
                            <td>{$row['email']}</td>
                          </tr>";
                    $no++;
                }
