...
<page>
    ...
    <div id="judul" class="text-center">
        <p class="text-underline">Laporan Data Nilai</p>
    </div>
    <div id="body">
        <?php
        // Connect to the database
        include 'connect.php'; // Ensure this file contains the correct database connection code

        $query = "select b.nama_peserta,c.nama_tema,d.namaKriteria, e.nilai,e.keterangan from nilai_peserta a
left join peserta b on b.id_peserta = a.id_peserta
left join jenis_tema c on c.id_jenistema = a.id_jenistema
left join kriteria d on d.id_kriteria = a.id_kriteria
left join nilai_kriteria e on e.id_nilaikriteria = a.id_nilaikriteria";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p class='text-center text-green'>Data kosong</p>";
        }
        ?>
    </div>
